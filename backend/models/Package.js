...
const packageSchema = new mongoose.Schema(
  {
    ...
    pax: { type: String, trim: true, default: '' },
    duration: { type: Number, required: true, min: 1 },
    basePrice: { type: Number, required: true, min: 0 },
    doubleSharingPrice: { type: Number, default: 0, min: 0 },
    singleSharingPrice: { type: Number, default: 0, min: 0 },
    childWithBedPrice: { type: Number, default: 0, min: 0 },
    childWithoutBedPrice: { type: Number, default: 0, min: 0 },
    infantPrice: { type: Number, default: 0, min: 0 },
    mealPlan: { type: String, trim: true, default: '' },
    flightDetails: { type: String, trim: true, default: '' },
    visaDetails: { type: String, trim: true, default: '' },
